...
export default class Http extends Abstract {
  ...
  connect() {
    if (!this.web3.currentProvider) {
      ...
      this.log.echo(`Setting Web3 provider to "${urlObject}"`);
      this.web3.setProvider(new this.web3.providers.HttpProvider(urlObject.toString, 0, urlObject.username, urlObject.password));
    }
